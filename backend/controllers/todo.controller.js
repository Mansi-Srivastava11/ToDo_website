...
import { asyncHandler } from "../middleware/asyncHandler.js"; // wrapper for try... catch
...
export const updateTodo = asyncHandler(async (req, res) => {
      ...
      //If Todo not found - created but deleted later, but id remains & todo deleted. It returns Todo not found.
      if(!todo){
        return res.status(404).json({
          success: false,
          message: "Todo not found",
...
export const deleteTodo = asyncHandler(async (req, res) => {
    ...
    //Validate ID based on mongoose
      ...
      //If Todo not found - created but deleted later, but id remains & todo deleted. It returns Todo not found. ID is valid but id, todo not available.
      if(!todo){
        return res.status(404).json({
          success: false,
          message: "Todo not found",
